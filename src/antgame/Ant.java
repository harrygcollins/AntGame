...
/**
 * This class represents the individual entity of an Ant in a game. They have
 * various variables used to define the characteristics of the ant object as
 * there will be multiple instances in the game at once.
 *
 * @author Team 13
 */
public class Ant {
     ...
     * @param startingX an integer representing the starting x coordinate of the
     * Ant
     * @param startingY an integer representing the starting y coordinate of the
     * Ant
    ...
    /**
     * @return an integer array containing the x and y coordinate of the ant
     * respectively
     */
    public int[] getPos() {
    ...
    /**
     * @param state an integer representing the new state to be assigned to the
     * ant
     */
    ...
    /**
     * @return an integer representing the colour of the ant (which team it's
     * on)
     */
    ...
    /**
     * @param resting an integer representing the new resting time to be
     * assigned
     */
    ...
    /**
     * @param deadOrAlive a boolean representing the new isDead value for the
     * ant
     */
